...
import DeepcleaningBanner from "./deepcleaningBanner.svg";

export default function DeepcleaningPage() {
  return (
    <>
      <Helmet>
        <title>Deep cleaning 2</title>
        <meta
          name="description"
      ...
      <div className="relative  w-full content-center bg-gray-200 self-stretch">
        <div className="flex flex-1 flex-col self-strech">
          ...
          <div className="mx-auto mt-[142px] flex w-full max-w-[1112px] flex-col items-start gap-12 self-stretch ">
            <Heading
              size="headings"
              as="h1"
        ...
        <div className="absolute left-0 right-0 top-[2%] z-[9]  flex flex-1 flex-col items-end">
          <Img
            src={DeepcleaningBanner}
            alt="Deepcleaningone"
